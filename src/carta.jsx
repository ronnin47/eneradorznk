...
const CardPj=({imagen,titulo,leyenda})=> {
  console.log(imagen)
  return (
    <Card style={{ width: '20rem', padding:"1px" , height:"29em"}} className='carta'>
      ...
      <Card.Body className='pergamino'>
        ...
        <Card.Text >
          <p style={{fontSize:"0.9em"}}>{leyenda}</p>
        </Card.Text>
      </Card.Body>
    </Card>
  );
...
export const Carta = ({dominio,naturaleza}) => {
 
 console.log(`${dominio} ${naturaleza}`)


 const [imagen,setImagen]=useState("../src/assets/base.jpg")
...
useEffect(()=>{
  ...
  switch (compuesto) {
    case "guerrero-bueno":
      ...
      newImagen = "../src/assets/gue-bue.jpg";
      newTitulo ="Bienhechor"
      newLeyenda="Solo levántate y con una gran sonrisa mira a los ojos del mal."
    ...
    case "guerrero-caotico":
      newImagen = "../src/assets/gue-cao.jpg";
      newTitulo="Tenaz"
      newLeyenda="Callate insecto!! ese ataque insignificante no se compara ni al mas debil de viejo sensei"
    ...
    case "guerrero-oscuro":
      newImagen = "../src/assets/gue-os.jpg";
    ...
    case "guerrero-neutral":
      newImagen = "../src/assets/gue-n.jpg";
      newTitulo="Luchador intrepido"
      newLeyenda="Guerra de Toran?. Crees que soy tan idiota para morir por una batalla legendaria?"
   ...
   case "hechicero-neutral":
      newImagen = "../src/assets/hechi-n.jpg";
      newTitulo="Alquimista mercante"
      newLeyenda="Estos atuendos mejoraran tu concetracion y tambien le llamaras la atecion a las chicas de tu academia"
    ...
    case "hechicero-caotico":
      newImagen = "../src/assets/hechi-cao.jpg";
    ...
    case "hechicero-bueno":
      newImagen = "../src/assets/hechi-bue.jpg";
      newTitulo="Caballero imperial"
      newLeyenda="No desperto su Hakai. Eso significa que su alma no esta perdida. Me alegra por el."
    ...
    case "hechicero-oscuro":
      newImagen = "../src/assets/hechi-os.jpg";
    ...
    //maestro de armas
    case "mArmas-neutral":
      newImagen = "../src/assets/mArmas-n.jpg";
      newTitulo="Explorador cauto"
      newLeyenda="Notoriamente el Kaiju que seguimos es gigantezca, mantendre mi distancia.Buena suerte muchachos!"
    ...
    case "mArmas-caotico":
      newImagen = "../src/assets/mArmas-cao2.jpg";
      newTitulo="Berserker"
      newLeyenda="No me interesa tu historia. Solo callate y muere"
    ...
    case "mArmas-bueno":
      newImagen = "../src/assets/mArmas-bue.jpg";
      newTitulo="Soldado del reino"
      newLeyenda="Eres el estandarte vivo de los heroes de tu nacion"
    ...
    case "mArmas-oscuro":
      newImagen = "../src/assets/mArmas-os.jpg";
    ...
    case "mSombras-neutral":
      newImagen = "../src/assets/mSombras-n.jpg";
      newTitulo="Ladron de Zendo"
      newLeyenda="Te metiste con el tipo equibocado idiota. Sera mejor que te despidas de esa bonita mochila"
    ...
    case "mSombras-caotico":
      newImagen = "../src/assets/mSombras-cao.jpg";
      newTitulo="Asesino de la Yakuza"
      newLeyenda="El jefe estara muy contento de ver tu respeto. Ahora dame tu mano, ahun tengo varios que visitar hoy."
    ...
    case "mSombras-bueno":
      newImagen = "../src/assets/mSombras-bue.jpg";
      newTitulo="Guardian de Himitsu"
      newLeyenda="Mi shinobido siempre buscara hayar el mejor camino para sofocar el mal"
    ...
    case "mSombras-oscuro":
      newImagen = "../src/assets/mSombras-os.jpg";
    ...
    case "mEspiritual-bueno":
      newImagen="../src/assets/mEspiritual-bue.jpg"
      newTitulo="Nexo del bosque"
      newLeyenda="Los leñadores me han jurado que no talaran sobre sus dominios.No los castigue gran antiguo"
    ...
    case "mEspiritual-neutral":
      newImagen="../src/assets/mEspiritual-n.jpg"
      newTitulo="Cazador Ayakashi"
      newLeyenda="Mimiku. Rastrea el aroma de esta prenda. El fantasma que buscamos pertenecio a esta villa"
    ...
    case "mEspiritual-caotico":
      newImagen="../src/assets/mEspiritual-cao.jpg"
      newTitulo="Pilar del fuego"
      newLeyenda="La batalla es inebitable. MarcHAremos en nombre de los Kamis de fuego. Extinguiremos su Hakai."
    ...
    case "mEspiritual-oscuro":
      newImagen="../src/assets/mEspiritual-os.jpg"
    ...
    case "cBakemono-bueno":
      newImagen="../src/assets/cBakemono-bue.jpg"
      newTitulo="Aventurero salvaje"
      newLeyenda="Con suerte podamos encontrar rivals en este pueblo. Que te parece una buena pelea Taro?"
    ...
    case "cBakemono-neutral":
      newImagen="../src/assets/cBakemono-n.jpg"
      newTitulo="Herborista"
      newLeyenda="El estiercol de trazgo es el secreto. Vamos frotalo en tu rostro y veras."
    ...
    case "cBakemono-caotico":
      newImagen="../src/assets/cBakemono-cao.jpg"
      newTitulo="Cazador de tierras inhospitas"
      newLeyenda="Vamos Raptor esos Wuargos no deben estar muy lejos de aqui."
    ...
    case "cBakemono-oscuro":
      newImagen="../src/assets/cBakemono-os.jpg"
      newTitulo="Dominador Kaiju"
      newLeyenda="Nadie que no sienta el instinto oscuro que habita en su ser, podra dominar la voluntad de un Kaiju"
    ...
    <div>
        ...
        <div style={{
         ...
         opacity:"revert"
           ...
           <div className={`animate__animated ${animacionActiva ? 'animate__fadeInLeftBig' : ''}`}>  
           <CardPj imagen={imagen} titulo={titulo} leyenda={leyenda}></CardPj> 
           </div>
           <div className={`animate__animated ${animacionActiva ? 'animate__fadeInRightBig' : ''}`}>  
           <p className='container textoCard'>{txt}</p>
           </div>
